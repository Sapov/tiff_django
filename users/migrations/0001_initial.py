    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_notification', models.BooleanField(blank=True, default=True, help_text='Установите Да если хотите получать уведомленияна электронную почту', null=True, verbose_name='Присылать уведомления на эл. почту')),
