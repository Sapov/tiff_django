...
def foo(*args):
    # pk1, name, age, text = args
    # print(pk1, name, age, text)
    print(args)
...
class EmailSender:
    ...
    def __init__(self, order_id: int, mail_address: str, order_pay_link:str):
        ...
        print(self.order_id, self.mail_address, self.order_pay_link)



foo(1, 'sasha@mail.ru', 'links')
