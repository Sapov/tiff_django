...
class OrdersDeliveryBus(models.Model):
    ...
    img_bus = models.ImageField(upload_to="img_bus/%Y/%m/%d/", verbose_name="Фото номера автобуса", blank=True, null=True)
    comments = models.TextField(verbose_name='Комментарии', blank=True, null=True, default='Набрать в 2-00')
