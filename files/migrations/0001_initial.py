    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Fields', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='files.fields', verbose_name='Поля вокруг изображения')),
                ('FinishWork', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='files.finishwork', verbose_name='Финишная обработка')),
                ('material', models.ForeignKey(default='2', on_delete=django.db.models.deletion.CASCADE, to='files.material', verbose_name='Материал')),
                ('status_product', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='files.statusproduct', verbose_name='Статус файла')),
            ],
            options={
                'verbose_name': 'Файл',
