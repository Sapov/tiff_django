...
def main():
    return generate_payment_link(merchant_login=os.getenv("MERCHANT_LOGIN"),
                                 merchant_password_1=os.getenv("PASSWORD_ONE"),
                                 cost=100,  # Cost of goods, RU
                                 number=1,  # Invoice number
                                 description='Печать баннера',  # Description of the purchase
                                 is_test=0,
                                 )
